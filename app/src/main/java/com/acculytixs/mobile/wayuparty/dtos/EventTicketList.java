...
public class EventTicketList implements Serializable
{

    @SerializedName("data")
    @Expose
    private List<EventTicketData> data = null;
    ...
    private final static long serialVersionUID = 4052837594029535216L;

    public List<EventTicketData> getData() {
        return data;
    }

    public void setData(List<EventTicketData> data) {
        this.data = data;
    }
